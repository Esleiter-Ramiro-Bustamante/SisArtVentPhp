    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>SVA-PHP</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>SVA-PHP</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="../public/dist/img/naruto.gif" class="user-image" alt="User Image">
                  <span class="hidden-xs">Esleiter Ramiro Bustamante Ataxca</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ...
                      <small>Email:esletutuns0307@gmail.com</small>
                    </p>
                  </li>
